  ...
  <div class="right-board">
    <el-tabs v-model="currentTab" class="center-tabs">
      <el-tab-pane label="组件属性" name="field">
        <span slot="label" style="margin-left: 20px"><el-icon><el-icon-tools /></el-icon> 组件属性</span>
      </el-tab-pane>
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.__vModel__ !== undefined" label="默认值">
            <el-input :model-value="setDefaultValue(activeData.__config__.defaultValue)" placeholder="请输入默认值"
              @input="onDefaultValueInput" />
          </el-form-item>
          <el-form-item v-if="activeData.__config__.tag === 'el-checkbox-group'" label="至少应选">
            <el-input-number :model-value="activeData.min" :min="0" placeholder="至少应选"
              @input="$set(activeData, 'min', $event ? $event : undefined)" />
          </el-form-item>
          <el-form-item v-if="activeData.__config__.tag === 'el-checkbox-group'" label="最多可选">
            <el-input-number :model-value="activeData.max" :min="0" placeholder="最多可选"
          ...
          <el-form-item v-if="activeData['prefix-icon'] !== undefined" label="前图标">
            <el-input v-model="activeData['prefix-icon']" placeholder="请输入前图标名称">
              <el-button slot="append" :icon="Thumb" @click="openIconsDialog('prefix-icon')">
                选择
              </el-button>
            </el-input>
          </el-form-item>
          <el-form-item v-if="activeData['suffix-icon'] !== undefined" label="后图标">
            <el-input v-model="activeData['suffix-icon']" placeholder="请输入后图标名称">
              <el-button slot="append" :icon="Thumb" @click="openIconsDialog('suffix-icon')">
                选择
              </el-button>
            </el-input>
          </el-form-item>
          ...
          " label="按钮图标">
            <el-input v-model="activeData['icon']" placeholder="请输入按钮图标名称">
              <el-button slot="append" :icon="Thumb" @click="openIconsDialog('icon')">
                选择
              </el-button>
            </el-input>
          </el-form-item>
          ...
          <el-form-item v-if="activeData['active-value'] !== undefined" label="开启值">
            <el-input :model-value="setDefaultValue(activeData['active-value'])" placeholder="请输入开启值"
              @input="onSwitchValueInput($event, 'active-value')" />
          </el-form-item>
          <el-form-item v-if="activeData['inactive-value'] !== undefined" label="关闭值">
            <el-input :model-value="setDefaultValue(activeData['inactive-value'])" placeholder="请输入关闭值"
          ...
          <el-form-item v-if="activeData.format !== undefined" label="时间格式">
            <el-input :model-value="activeData.format" placeholder="请输入时间格式" @input="setTimeValue($event)" />
          </el-form-item>
          <template v-if="
          ...
          ">
            ...
            <draggable :list="activeData.__slot__.options" :animation="340" group="selectItem" handle=".option-drag">
              <div v-for="(item, index) in activeData.__slot__.options" :key="index" class="select-item">
                ...
                <el-input placeholder="选项值" size="small" :model-value="item.value"
            ...
            <div style="margin-left: 20px">
              <el-button style="padding-bottom: 0" :icon="CirclePlusOutline" type="text" @click="addSelectItem">
                添加选项
              </el-button>
            </div>
            <el-divider />
          ...
          ">
            ...
            <div v-if="activeData.__config__.dataType === 'static'" style="margin-left: 20px">
              <el-button style="padding-bottom: 0" :icon="CirclePlusOutline" type="text" @click="addTreeItem">
                添加父级
              </el-button>
            </div>
            <el-divider />
          ...
          <template v-if="Array.isArray(activeData.__config__.regList)">
            ...
            <div style="margin-left: 20px">
              <el-button :icon="CirclePlusOutline" type="text" @click="addReg">
                添加规则
              </el-button>
            </div>
          </template>
